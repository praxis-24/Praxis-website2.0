...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-black/80 backdrop-blur-sm shadow-md">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className="text-neutral-content hover:text-primary transition-colors font-medium"
            >
              Home
            </Link>
            <a
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden bg-black/80 backdrop-blur-sm shadow-lg transition-all duration-300 ${
          mobileMenuOpen
      ...
      >
        <div className="container mx-auto px-4 py-4 space-y-4">
          <Link
            to="/"
            className="block text-neutral-content hover:text-primary transition-colors font-medium"
          >
            Home
          </Link>
          <a
